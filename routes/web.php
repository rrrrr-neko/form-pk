...
Route::get('/dod/view', [App\Http\Controllers\IndexController::class, 'view_form_dod'])->name('view_form_dod');
Route::post('/dod/view', [App\Http\Controllers\AnswersDodController::class,'add_answer'])->name('add_answer');
